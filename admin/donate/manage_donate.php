...
<div class="card card-outline card-info">
	...
	<div class="card-body">
		<form action="" id="blog-form">
            ...
            <div class="form-group">
                ...
                <option value=""></option>
                <?php
                    $qry = $conn->query("SELECT * FROM `dtopic` order by `name` asc");
            ...
            <div class="form-group">
				<label for="keywords" class="control-label">Keywords <small>(separate the keywors using comma ",")</small></label>
            ...
            $upload_path = "upload/blog_uploads/".$upload_dir_code;
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=donate">Cancel</a>
	</div>
</div>
...
<script>
    ...
    function upload_images(input,_this){
			start_loader();
            $.ajax({
				url:_base_url_+"classes/Master.php?f=upload_files_donation",
