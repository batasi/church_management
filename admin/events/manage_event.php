...
<div class="card card-outline card-info">
	...
	<div class="card-body">
		<form action="" id="event-form">
			...
			<div class="form-group">
				<label for="schedulestart" class="control-label">Start Time</label>
                <input type="time" class="form-control form" required name="schedulestart" value="<?php echo isset($schedulestart) ? $schedulestart : '' ?>">
            </div>
			<div class="form-group">
				<label for="scheduleend" class="control-label">End Time</label>
                <input type="time" class="form-control form" required name="scheduleend" value="<?php echo isset($scheduleend) ? $scheduleend : '' ?>">
            </div>
			<div class="form-group">
